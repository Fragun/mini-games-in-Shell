...
while true; do
    echo -n "Choisissez la difficulté, tapez 1 [1-100] en 7 coups, tapez 2 [1-200] en 10 coups, tapez 3 [1-500] en 12 coups, tapez 4 [1-5000] en 14 coups : "
    read level
...
while [[ $numberUser -ne $nombreCible ]]; do
    ...
    if [[ $count -gt $countMax ]]; then
        echo "Dommage vous n'avez pas réussi en moins de $countMax coups."
        break
    fi
